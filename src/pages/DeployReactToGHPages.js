    ...
    return (
        <>
            ...
            <p className="mt-5 sub-heading">
                <span className="fw-bold fs-4">First,</span> We must include the Github Pages Dependency Package.
            ...
            <p className="mt-5 sub-heading">
                <span className="fw-bold fs-4">Second,</span> the package.json file will also need to include predeploy and deploy scripts. 
                The React application is packaged using the predeploy script, and is then deployed using 
                the deploy script.
            </p>
                
            <p className="sub-heading">
                Scroll down to the scripts property in the package.json file and add the following commands:
            </p>
            ...
            <p className="mt-5 mb-4 sub-heading">
                <span className="fw-bold fs-4">Third,</span> We must add a homepage property with the following format to the package.json 
                file: http://github-username.github.io/repo-name
            </p>
            <h4>Visual Referrence:</h4>
            <img src={homepageexample} alt="homepage-example"/>

            <p className="mt-5 mb-3 sub-heading">
                All done! The package.json file has been fully configured. Let's push the code to the 
                remote repository and commit our changes now as follows:
            </p>
            ...
            <p className="sub-heading">
                Now Deploy your React project to GH Pages: at this time by typing the following command into your 
                terminal: <span className="fw-bold">npm run deploy</span> By doing this, a bundled version of our React application will be 
                produced and pushed to a gh-pages branch in our remote GitHub repository. The deployment process will take a moment,
                Once the deployment is complete, you'll see a success message in your terminal. Your React app is now live on GitHub Pages!
            </p>
            <h1 className="mt-5">Verify Your Deployment</h1>
            <p className="sub-heading mb-4">
                Before sharing your new React app with the world, it's essential to verify that the deployment was successful. Follow these steps to ensure everything is in order:
            </p>
