import homepageexample from "../assets/vite/homepage.png";
import scriptexample from "../assets/vite/script.png";
import poster from "../assets/poster/VitetoGithubposter.gif";
import Footer from "../components/Footer";
import { Link } from "react-router-dom";

function DeployViteReactToGHPages() {
    return(
        <>
            <div className="container p-5">
                ...
                <nav aria-label="breadcrumb">
                    <ol className="breadcrumb">
                        ...
                        <li className="breadcrumb-item active" aria-current="page">deploy-vitereactapp-to-gh-pages</li>
                    </ol>
                </nav>

                <h1 className="mt-5 mb-1">Deploy a Vite React App to GitHub Pages</h1>
                ...
                <h1 className="mt-5 mb-5">Configure your Vite React Project</h1>

                <p className="fw-bold mb-4 sub-heading">
                    With your Vite React App code committed and pushed to your GitHub repository, 
                ...
                <p className="mt-5 mb-4 sub-heading">
                    ...
                    the following format to the vite.config.js file.
                </p>
                ...
                <p className="mt-5 mb-3 sub-heading">
                    All done! The vite.config.js and package.json file has been fully configured. Let's push the code to 
                ...
                <p className="sub-heading">
                    Now Deploy your Vite React App project to GH Pages: at this time by typing the following 
                    command into your terminal: <span className="fw-bold">npm run deploy</span> By 
                    doing this, a bundled version of our Vite React application will be produced and pushed 
...
export default DeployViteReactToGHPages;